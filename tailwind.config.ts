    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          ...
          "review-glow": "hsl(var(--status-review-glow))",
      ...
      keyframes: {
        ...
        "badge-pulse": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(var(--status-expired) / 0.4)" },
          "50%": { boxShadow: "0 0 0 8px hsl(var(--status-expired) / 0)" },
        },
        "slide-in": {
        ...
        "stamp-in": {
          from: { opacity: "0", transform: "scale(0.9) rotateX(-15deg)" },
      ...
      animation: {
        ...
        "badge-pulse": "badge-pulse 2s ease-out infinite",
